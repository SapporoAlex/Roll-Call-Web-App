...
<div style="display: flex; flex-direction: row; gap: 10px; padding: 15px; background-color: grey; border-radius: 5px; border: 3px solid black; width: fit-content; border: 3px solid red; height: 200px;">
